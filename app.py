...
MODE_NAMES = {
    "EIGHT_ONE": "Solo", "EIGHT_TWO": "Duos", "FOUR_THREE": "3v3v3v3",
    "FOUR_FOUR": "4v4v4v4", "TWO_FOUR": "4v4", "EIGHT_ONE_RUSH": "Solo Rush",
    "EIGHT_TWO_RUSH": "Duos Rush", "FOUR_FOUR_RUSH": "4v4v4v4 Rush",
    "EIGHT_ONE_ULTIMATE": "Solo Ultimate", "EIGHT_TWO_ULTIMATE": "Duos Ultimate",
    "FOUR_FOUR_ULTIMATE": "4v4v4v4 Ultimate", "EIGHT_TWO_LUCKY": "Duos Lucky",
    "FOUR_FOUR_LUCKY": "4v4v4v4 Lucky", "EIGHT_TWO_VOIDLESS": "Duos Voidless",
    "FOUR_FOUR_VOIDLESS": "4v4v4v4 Voidless", "EIGHT_TWO_ARMED": "Duos Armed",
    "FOUR_FOUR_ARMED": "4v4v4v4 Armed",
    "ranked_normal": "Ranked", "solo_normal": "Solo Normal",
    "solo_insane": "Solo Insane", "teams_normal": "Teams Normal",
    "teams_insane": "Teams Insane", "mega_normal": "Mega", "mega_doubles": "Mega Doubles",
    "DUEL_CLASSIC": "Classic 1v1", "DUEL_BOW": "Bow 1v1", "DUEL_BLITZ": "Blitz 1v1",
    "DUEL_BOWSPLEEF": "Bow Spleef 1v1", "DUEL_COMBO": "Combo 1v1",
    "DUEL_NODEBUFF": "No Debuff 1v1", "DUEL_POTION": "Potion 1v1",
    "DUEL_SUMO": "Sumo 1v1", "DUEL_UHC": "UHC 1v1", "UHC_DOUBLES": "UHC 2v2",
    "SW_DUEL": "SkyWars 1v1", "SW_DOUBLES": "SkyWars 2v2",
    "OP_DUEL": "OP 1v1", "OP_DOUBLES": "OP 2v2",
    "BRIDGE_DUEL": "The Bridge 1v1", "BRIDGE_DOUBLES": "The Bridge 2v2",
    "BRIDGE_THREES": "The Bridge 3v3", "BRIDGE_FOUR": "The Bridge 4v4",
    "MURDER_CLASSIC": "Classic", "MURDER_DOUBLE_UP": "Double Up",
    "MURDER_ASSASSINS": "Assassins", "MURDER_INFECTION": "Infection",
    "LOBBY": "Lobby", "lobby": "Lobby", "dynamic": "Island",
}

GAME_NAMES = {
    "BEDWARS": "Bed Wars", "SKYWARS": "Sky Wars", "DUELS": "Duels",
    "MURDERMYSTERY": "Murder Mystery", "SKYBLOCK": "SkyBlock",
    "HOUSING": "Housing", "ARCADE": "Arcade", "TNTGAMES": "TNT Games",
    "UHCCHAMPIONS": "UHC Champions", "SPEEDUHC": "Speed UHC",
    "MEGAWALLS": "Mega Walls", "VAMPIREZ": "VampireZ", "WALLS": "Walls",
    "PAINTBALL": "Paintball", "QUAKE": "Quakecraft", "ARENA": "Arena Brawl",
    "SURVIVAL_GAMES": "Blitz SG", "BUILDBATTLE": "Build Battle",
    "BATTLEGROUND": "Warlords", "GINGERBREAD": "Turbo Kart Racers",
    "MAIN": "Hauptlobby",
}


def format_uuid(uuid_raw: str) -> str:
    u = uuid_raw.replace("-", "")
...
def calc_network_level(xp: float) -> float:
    if xp <= 0:
        return 1.0
...
def get_rank(player: dict) -> str:
    ...
    if monthly == "SUPERSTAR":
        return "MVP++"
    return rank_map.get(rank, "Kein Rang")
...
def player_stats(username):
    ...
    mode_display = MODE_NAMES.get(mode_raw, mode_raw.replace("_", " ").title()) if mode_raw else None
